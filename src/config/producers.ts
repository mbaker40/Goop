...
export interface ProducerDef {
  id: string;
  name: string;
  /** Emoji icon shown in the shop / HUD (new-player readability; render layer may swap for SVG). */
  icon: string;
...
export const PRODUCERS: readonly ProducerDef[] = [
  { id: 'dripper', name: 'Goop Dripper', icon: '💧', baseCost: 15, baseGps: 0.1, flavor: 'A leaky faucet, but goop.' },
  { id: 'intern', name: 'Goop Intern', icon: '🧑‍💼', baseCost: 100, baseGps: 1, flavor: 'Unpaid. Sighs audibly.' },
  { id: 'cannon', name: 'Goop Cannon', icon: '💥', baseCost: 1_100, baseGps: 8, flavor: 'Fires goop at the tower. Sometimes misses (visual only).' },
  { id: 'union', name: 'Unionized Goop Workers', icon: '👷', baseCost: 12_000, baseGps: 47, flavor: 'Tiny goop guys climbing the tower. Demand breaks.' },
  { id: 'goopcopter', name: 'Goopcopter', icon: '🚁', baseCost: 130_000, baseGps: 380, flavor: 'Helicopter made of goop. Physically upsetting.' },
  { id: 'reactor', name: 'Goop Reactor', icon: '☢️', baseCost: 1.4e6, baseGps: 2_600, flavor: 'Do not ask what it fissions.' },
